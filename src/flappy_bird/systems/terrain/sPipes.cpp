...
void PipesSystem::init(entt::registry& registry) {
  ...
  registry.get<nl::CShader>(green_pipe_top).visible = false;
  ...
  registry.get<nl::CShader>(green_pipe_bottom).visible = false;
  ...
  registry.get<nl::CShader>(red_pipe_top).visible = false;
  ...
  registry.get<nl::CShader>(red_pipe_bottom).visible = false;
...
void PipesSystem::update(entt::registry& registry, const nl::Time& ts) {
  ...
  registry.view<nl::CShader, nl::CTransform, nl::CTag, nl::CName, nl::CUUID>().each(
    [&](nl::CShader& CShader, nl::CTransform& cTransform, const nl::CTag& cTag, const nl::CName& cName,
